...
class MyGUI():
    def __init__(self):
        ...
        #Creat a welcome label
        self.welcome_label = tkinter.Label(self.top_frame, text ='Diamond Price Predictor', bg = 'lightgray')
        ...
        self.carat_label.grid(row=1, column=0, pady = 5)
        self.carat_entry.grid(row=1, column=1)
        ...
        self.y_label.grid(row=3, column=0, pady = 5)
        ...
        self.z_label.grid(row=4, column=0, pady = 5)
        ...
        self.cut_label.grid(row=5, column=0, pady = 5)
        self.cut_entry.grid(row=5, column=1)
        ...
        self.color_label.grid(row=6, column=0, pady = 5)
        ...
        self.clarity_label.grid(row=7, column=0, pady = 5)
        self.clarity_entry.grid(row=7, column=1)

        # Predict Button
        self.predict_button = tkinter.Button(self.top_frame, text='Predict', command=self.predict_price)
        self.predict_button.grid(row=8, column=0, pady=10)
    ...
    def predict_price(self):
        ...
        #Make prediction
        predicted_price = XGB_Model.predict([[carat, x, y, z, cut_dictionary[cut], color_dictionary[color], clarity_dictionary[clarity]]])
